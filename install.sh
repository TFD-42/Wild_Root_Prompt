...
echo ""
echo "============================================================"
echo "   Wild_Root_Prompt  —  Automatic Installation"
echo "   macOS / Linux"
echo "============================================================"
echo ""
...
if command -v ollama &>/dev/null; then
    ...
    if [ "$OS_LABEL" = "Termux (Android)" ]; then
        ...
        warn "You can use a remote Ollama server. Configure the URL in Wild_Root_Prompt settings."
...
cd "$SCRIPT_DIR"
echo ""
echo "  Starting Wild_Root_Prompt..."
