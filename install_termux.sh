#!/usr/bin/env bash
# ============================================================
#  Wild_Root_Prompt Installer — Android / Termux
...
echo ""
echo "============================================================"
echo "   Wild_Root_Prompt  —  Termux / Android Installer"
echo "============================================================"
echo ""
warn "Ollama does not run on Android/Termux."
echo "  You need a remote Ollama server on your PC or a LAN server."
echo "  After installation, set the Ollama URL in Wild_Root_Prompt:"
...
echo ""
echo "  Wild_Root_Prompt — Termux Mode"
echo "  ─────────────────────────"
...
echo "  3. In Wild_Root_Prompt menu 8, set Ollama URL to:"
